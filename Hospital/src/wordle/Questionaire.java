...
public class Questionaire 
{
	...
	public static void main(String args[])throws FileNotFoundException 
	{
        ...
        String WordleOfTheDay = WordleWord[dayOfYear - 1];
		
        System.out.println(WordleOfTheDay);
		...
		do
		{
			System.out.println("Are you a nurse(N) or doctor(D)? [press Q to quit questionaire] ");
		...
		while(!(position.equals ("Q")))
		{
			...
			}while ((!(position.equals("D")))&&(!(position.equals("N")))&&(!(position.equals("Q"))));
